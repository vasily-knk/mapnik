...
public:
    ...
    /*!
     * @param minimum_scale_denominator The minimum zoom level to set
     */
    void set_minimum_scale_denominator(double minimum_scale_denom);

    /*!
     * @param maximum_scale_denominator The maximum zoom level to set
     */
    ...
    /*!
     * @brief Get the visibility for a specific scale_denominator.
     *
     * @param scale_denominator Accepts an integer or float input.
     *
     * @return true if this layer's data is active and visible at a given scale_denominator.
